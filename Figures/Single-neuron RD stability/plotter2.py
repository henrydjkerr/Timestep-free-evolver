...
#This is one I'm just using for a presentation
...
plt.fill_betweenx(stable_R, stable_D, -4, color = "#999999")
...
plt.fill_betweenx(stable_R, 0, -3,
                  color = blue3, alpha = 0.8)
plt.fill_between(x_plain[150:], osc_R[150:], -3,
                 color = blue3, alpha = 0.8)
...
plt.tight_layout()
if print_mode:
    plt.savefig("1neuron_important.pdf")
    plt.savefig("1neuron_important.png")
else:
    plt.show()
