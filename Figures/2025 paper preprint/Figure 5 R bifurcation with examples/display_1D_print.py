...
def make_graph(filename):
    ...
    plt.figure(figsize=(2,3.5), dpi=400)
    ax = plt.axes()
    if not empty:
    ...
    if not empty:
        ...
        plt.savefig(filename + "empty.pdf")

ymax = 0
make_graph("output-20250725130349-2000N-4000sp")
make_graph("output-20250725130656-2000N-4000sp")
make_graph("output-20250725131030-2000N-4000sp")
make_graph("output-20250725131229-2000N-4000sp")
make_graph("output-20250725131443-2000N-4000sp")
ymax = 1
make_graph("output-20250725131611-2000N-4000sp")
