...
branches = {
    ...
    "2nd_branch_postgraze.txt" : {
        "colour" : blue1fade,
        "linestyle" : "dotted"},
    "3rd_branch_pregraze.txt" : { #--- 3
        "colour" : blue1,
        "linestyle" : "solid",
        "graze" : False},
    "3rd_branch_prepregraze.txt" : {
        "colour" : blue1,
        "linestyle" : "solid"},
    ...
    "4th_branch_pregraze.txt" : { #--- 4
        ...
        "linestyle" : "dotted",
        "graze" : False},
    "4th_branch_prepregraze.txt" : {
        "colour" : blue1,
        "linestyle" : "dotted"},
    "4th_branch_postgraze.txt" : {
        "colour" : blue1fade,
        "linestyle" : "dotted"},
    "5th_branch_pregraze.txt" : { #--- 5
        "colour" : blue1,
        "linestyle" : "solid",
        "graze" : False},
    "5th_branch_prepregraze.txt" : {
        "colour" : blue1,
        "linestyle" : "solid"},
...
if print_mode:
    plt.savefig("2spike_natural_frequency_D={}.pdf".format(D))
